...
def main():
    ...
    #         properties['pwn']['exploit'] = formatLeak.checkLeak(args.file, properties, remote_server=True,
    #                                                             remote_url=args.url, port_num=int(args.port))
    ...
    #     if properties['pwn_type'] is not None and 'flag_found' in properties['pwn_type'].keys() and \
    #             properties['pwn_type']['results']['flag_found'] and args.url is not "":
    #         properties['pwn_type']['send_results'] = formatExploiter.getRemoteFormat(properties, remote_url=args.url,
